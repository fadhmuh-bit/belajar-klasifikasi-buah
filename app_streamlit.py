...
ukuran_cm = st.slider("Ukuran Cm", 6.0, 8.0, 10.0)
berat_gram = st.slider("Berat gram", 150.0, 200.0, 280.0)
tingkat_kemanisan = st.slider("Tingkat Kemanisan", 7.0, 10.0, 14.0)
tingkat_keasaman = st.slider("Tingkat Keasaman", 2, 4, 6)
